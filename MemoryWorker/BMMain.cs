...
namespace Memory
{
	...
	/// </summary>
	sealed public partial class MemoryWorker
	{
		#region Variables
		//##CONSTANTS#########################################################
		...
		public MemoryWorker(int ProcessId) : this()
		{
		...
		public MemoryWorker(IntPtr WindowHandle) : this(SProcess.GetProcessFromWindow(WindowHandle))
		{ }
		#endregion
